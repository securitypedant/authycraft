...
public class AuthyVerify extends CommandBase {
	...
	public AuthyVerify ()
	  {
	    ...
	    this.aliases.add("atverify");
	    this.aliases.add("authyverify");
	  }

	  @Override
	  public String getCommandName()
	  {
	    return "Authy token verification";
	  }

	  @Override
	  public String getCommandUsage(ICommandSender icommandsender)
	  {
	    return "atverify 123456";
	  }
